...
function deepObjectAssignNonentry() {
  ...
  if (values.length < 2) {
    ...
    return deepObjectAssignNonentry.apply(void 0, concat$2(_context = [deepObjectAssign(values[0], values[1])]).call(_context, toConsumableArray(slice$2(values).call(values, 2))));
  }
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (Object.prototype.propertyIsEnumerable.call(b, b[prop])) {// Ignore nonenumerable props, Object.assign() would do the same.
