...
function createProject(req,res){
    req.body.cp_pm_Create != undefined ? cp_pm_Create = true: cp_pm_Create = false;
    req.body.cp_pm_Delete != undefined ? cp_pm_Delete = true: cp_pm_Delete = false;
    req.body.cp_pm_Update != undefined ? cp_pm_Update = true: cp_pm_Update = false;
    req.body.cp_rp_Create != undefined ? cp_rp_Create = true: cp_rp_Create = false;
    req.body.cp_rp_Delete != undefined ? cp_rp_Delete = true: cp_rp_Delete = false;
    req.body.cp_rp_Update != undefined ? cp_rp_Update = true: cp_rp_Update = false;
    req.body.cp_r_Create != undefined ? cp_r_Create = true: cp_r_Create = false;
    req.body.cp_r_Delete != undefined ? cp_r_Delete = true: cp_r_Delete = false;
    req.body.cp_r_Update != undefined ? cp_r_Update = true: cp_r_Update = false;
