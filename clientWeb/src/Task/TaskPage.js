  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div>
          <h3 id="form1" onClick={() => this.toggle(1)}>
            Create Task {this.state.form1 ? "\u25BE" : "\u25B4"}
          </h3>
          {this.state.form1 ? null : <CreateTaskForm />}
          <h3 id="form2" onClick={() => this.toggle(2)}>
            Create Dependency {this.state.form2 ? "\u25BE" : "\u25B4"}
          </h3>
          {this.state.form2 ? null : <CreateDependencyForm />}
          <h3 id="form3" onClick={() => this.toggle(3)}>
            Delete Task {this.state.form3 ? "\u25BE" : "\u25B4"}
          </h3>
          {this.state.form3 ? null : <DeleteTaskForm />}
          <h3 id="form4" onClick={() => this.toggle(4)}>
            Delete Dependency {this.state.form4 ? "\u25BE" : "\u25B4"}
          </h3>
          {this.state.form4 ? null : <DeleteDependencyForm />}
          <h3 id="form5" onClick={() => this.toggle(5)}>
            Update Task {this.state.form5 ? "\u25BE" : "\u25B4"}
          </h3>
          {this.state.form5 ? null : <UpdateTaskForm />}
          <h3 id="form6" onClick={() => this.toggle(6)}>
            Update Dependency {this.state.form6 ? "\u25BE" : "\u25B4"}
          </h3>
          {this.state.form6 ? null : <UpdateDependencyForm />}
          <h3>{this.props.projectID}</h3>
          <Link to="/project">
            <button onClick={() => this.props.toggleGraphPage(null)}>
              Back
            </button>
          </Link>
        </div>
  ...
  render() {
    return (
      <form method="post" action="/task/add">
        <label for="ct_taskName"> Name of task</label>
        <br />
        <input type="text" name="ct_taskName" /> <br />
        <br />
        <label for="ct_startDate"> Start Date</label>
        <br />
        <input
          type="date"
          name="ct_startDate"
        ...
        <br />
        <br />
        <label for="ct_duration"> Duration (Days) </label>
        <br />
        <input
          type="number"
          name="ct_duration"
        ...
        <br />
        <br />
        <label for="ct_endDate"> End date </label>
        <br />
        <input type="date" name="ct_endDate" id="ct_endDate" readonly /> <br />
        <br />
        <label for="ct_description"> Description </label>
        <br />
        <textarea name="ct_description" cols="30" rows="10"></textarea>
        <br />
        <label for="ct_resPersonId"> Responsible Person </label>
        <br />
        <input type="number" min="0" name="ct_resPersonId" />
        <br />
        <br />
        <label for="ct_pacManId"> Package Manager </label>
        <br />
        <input type="number" min="0" name="ct_pacManId" />
        <br />
        <br />
        <label for="ct_resourceId"> Resources </label>
        <br />
        <input type="text" min="0" name="ct_resourceId" />
        <br />
        <br />
  ...
  render() {
    return (
      <form method="post" action="/dependency/add">
        ...
        <select name="cd_relationshipType">
          {" "}
          <br />
  ...
  render() {
    return (
      <form action="/task/delete" method="post">
        <label for="fname">Enter ID to delete:</label>
        <br />
  ...
  render() {
    return (
      <form action="/dependency/delete" method="post">
        <label for="fname">Enter 1st ID dependency to delete:</label>
        <br />
        <input type="number" name="dep1" />
        <br />
        <label for="fname">Enter 2nd ID dependency to delete:</label>
        <br />
        <input type="number" name="dep2" />
        <br />
        <input type="submit" value="Submit" />
      </form>
    );
    ...
    return (
      <div>
        <form action="/" method="get">
          <label for="ut_id_select">Select Task by ID:</label>
          <br />
          <input
            name="ut_id_select"
            id="ut_id_select"
        ...
        <form id="extraForm" action="/task/update" method="post">
          ...
          <br />
          <br />
          <label for="ut_startDate">Start Date:</label>
          <br />
          <input
            name="ut_startDate"
            id="ut_startDate"
          ...
          <br />
          <br />
          <label for="ut_duration">Duration:</label>
          <br />
          <input
            name="ut_duration"
            id="ut_duration"
          ...
          <br />
          <br />
          <label for="ut_endDate">End Date:</label>
          <br />
  ...
  render() {
    return (
      <form action="/dependency/update" method="post">
        ...
        <label for="ud_Fid">Select First Task by ID:</label>
        <br />
        <input name="ud_Fid" type="number" min="0" />
        <br />
        <br />
        <label for="ud_Sid">Select Second Task by ID:</label>
        <br />
        <input name="ud_Sid" type="number" min="0" />
        <br />
        <br />
        <label for="ud_relationshipType">Select Relationship Type:</label>
        <br />
        ...
        <br />
        <br />
        <label for="ud_duration">Duration:</label>
        <br />
