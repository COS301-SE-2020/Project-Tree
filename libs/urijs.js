          ...
          (function (root, factory) {
            ...
            var SLD = {
              ...
              has: function (domain) {
                ...
                return (
                  sldList.indexOf(
                    " " + domain.slice(sldOffset + 1, tldOffset) + " "
                  ) >= 0
                );
              },
              is: function (domain) {
                ...
                return (
                  sldList.indexOf(" " + domain.slice(0, tldOffset) + " ") >= 0
                );
              },
              get: function (domain) {
                var tldOffset = domain.lastIndexOf(".");
      ...
      urijs: [
        function (require, module, exports) {
          ...
          (function (root, factory) {
            ...
            for (_part in _parts) {
              URI[_part + "PathSegment"] = generateAccessor(
                "pathname",
                _parts[_part]
              );
              URI[_part + "UrnPathSegment"] = generateAccessor(
                "urnpath",
                _parts[_part]
              );
            }
              ...
              return function (string) {
                ...
                if (!_innerCodingFuncName) {
                  ...
                  actualCodingFunc = function (string) {
                    return URI[_codingFuncName](
                      URI[_innerCodingFuncName](string)
                    );
                  };
                }
            ...
            URI.parse = function (string, parts) {
              ...
              if (string.substring(0, 2) === "//") {
                ...
                if (pos > -1) {
                  ...
                  if (
                    parts.protocol &&
                    !parts.protocol.match(URI.protocol_expression)
                  ) {
            ...
            URI.parseHost = function (string, parts) {
              ...
              if (string.charAt(0) === "[") {
                ...
                if (
                  nextColon !== -1 &&
                  (firstSlash === -1 || nextColon < firstSlash)
                ) {
            ...
            URI.parseQuery = function (string, escapeQuerySpace) {
              ...
              for (var i = 0; i < length; i++) {
                ...
                value = v.length
                  ? URI.decodeQuery(v.join("="), escapeQuerySpace)
                  : null;
              ...
              for (key in data) {
                if (hasOwn.call(data, key)) {
                  if (isArray(data[key])) {
                    ...
                    t +=
                      "&" +
                      URI.buildQueryParameter(key, data[key], escapeQuerySpace);
                  }
                }
              }
            ...
            URI.buildQueryParameter = function (name, value, escapeQuerySpace) {
              ...
              return (
                ...
                (value !== null
                  ? "=" + URI.encodeQuery(value, escapeQuerySpace)
                  : "")
              );
            };
            ...
            URI.withinString = function (string, callback, options) {
              ...
              while (true) {
                ...
                if (options.ignoreHtml) {
                  // attribut(e=["']?$)
                  var attributeOpen = string.slice(
                    Math.max(start - 3, 0),
                    start
                  );
                ...
                while (true) {
                  ...
                  var parensMatchEnd =
                    parensMatch.index + parensMatch[0].length;
                  parensEnd = Math.max(parensEnd, parensMatchEnd);
                }

                if (parensEnd > -1) {
                  slice =
                    slice.slice(0, parensEnd) +
                    slice.slice(parensEnd).replace(_trim, "");
                } else {
            ...
            URI.ensureValidHostname = function (v, protocol) {
              ...
              if (hasProtocol) {
                rejectEmptyHostname = arrayContains(
                  URI.hostProtocols,
                  protocol
                );
              }
              ...
              if (rejectEmptyHostname && !hasHostname) {
                ...
                if (
                  punycode.toASCII(v).match(URI.invalid_hostname_characters)
                ) {
                  throw new TypeError(
                    'Hostname "' +
                      v +
            ...
            p.href = function (href, build) {
              ...
              var _object =
                typeof href === "object" &&
                (href.hostname || href.path || href.pathname);
              if (href.nodeName) {
            ...
            p.is = function (what) {
              ...
              if (this._parts.hostname) {
                ...
                punycode =
                  name && URI.punycode_expression.test(this._parts.hostname);
              }
            ...
            p.authority = function (v, build) {
              ...
              if (v === undefined) {
                return this._parts.hostname
                  ? URI.buildAuthority(this._parts)
                  : "";
              } else {
            ...
            p.domain = function (v, build) {
              ...
              if (v === undefined) {
                ...
                var end =
                  this._parts.hostname.length - this.tld(build).length - 1;
            ...
            p.directory = function (v, build) {
              ...
              if (v === undefined || v === true) {
                ...
                var res =
                  this._parts.path.substring(0, end) ||
            ...
            p.segment = function (segment, v, build) {
              ...
              if (segment !== undefined && typeof segment !== "number") {
                throw new Error(
                  'Bad segment "' + segment + '", must be 0-based integer'
                );
              }
            ...
            p.segmentCoded = function (segment, v, build) {
              ...
              if (v === undefined) {
                ...
                if (!isArray(segments)) {
                  segments =
                    segments !== undefined ? URI.decode(segments) : undefined;
                } else {
        ...
        { "./IPv6": 1, "./SecondLevelDomains": 2, "./punycode": 3 },
      ],
    },
    {},
    []
