      ...
      "oauth-1.0a": [
        function (require, module, exports) {
          ...
          function OAuth(opts) {
            ...
            this.body_hash_function =
              opts.body_hash_function || this.hash_function;
          }
          ...
          OAuth.prototype.authorize = function (request, token) {
            ...
            if (request.includeBodyHash) {
              oauth_data.oauth_body_hash = this.getBodyHash(
                request,
                token.secret
              );
            }
          ...
          OAuth.prototype.getBodyHash = function (request, token_secret) {
            ...
            return this.body_hash_function(
              body,
              this.getSigningKey(token_secret)
            );
          };
          ...
          OAuth.prototype.getNonce = function () {
            ...
            for (var i = 0; i < this.nonce_length; i++) {
              result +=
                word_characters[
                  parseInt(Math.random() * word_characters.length, 10)
                ];
            }
