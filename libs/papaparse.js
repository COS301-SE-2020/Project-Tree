                ...
                return (
                  m() &&
                    (function () {
                      if (!c) return;
                      function e(e, t) {
                        U(_.transformHeader) && (e = _.transformHeader(e, t)),
                          l.push(e);
                      }
                  ...
                  (function () {
                    if (!c || (!_.header && !_.dynamicTyping && !_.transform))
                      return c;
                    function e(e, t) {
                      var i,
                        r = _.header ? {} : [];
                      for (i = 0; i < e.length; i++) {
                        var n = i,
                          s = e[i];
                        _.header &&
                          (n = i >= l.length ? "__parsed_extra" : l[i]),
                ...
                for (
                  ...
                  if (a[M] !== O)
                    ...
                    for (_ = M, M++; ; ) {
                      ...
                      if (_ === r - 1)
                        return E(a.substring(M, _).replace(m, O));
                      if (O !== z || a[_ + 1] !== z) {
                        if (O === z || 0 === _ || a[_ - 1] !== z) {
