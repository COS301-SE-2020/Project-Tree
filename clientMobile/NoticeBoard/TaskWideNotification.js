...
export default class SendTaskWideNotificationWrapper extends Component {
  constructor(props) {
    super(props);
    this.state = {modalVisible: false, notificationRec: []};
    ...
    return (
      <React.Fragment>
        ...
        <SendNotificationModal
          ...
          notificationRec={this.state.notificationRec}
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <SendNotificationForm
              ...
              project={this.props.project}
              user={this.props.user}
              notificationRec={this.props.notificationRec}
              task={this.props.task}
